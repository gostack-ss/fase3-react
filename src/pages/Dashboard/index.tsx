...
interface ResponseGetTransactions {
  balance: Balance;
...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const transactionsWithValueFormated = responseTransactions.map(
        transaction => {
          const formattedDate = `${new Date(
            transaction.created_at,
          ).getDate()}/${new Date(
            transaction.created_at,
          ).getMonth()}/${new Date(transaction.created_at).getFullYear()}`;
      ...
      setTransactions(transactionsWithValueFormated);
